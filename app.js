...
app.get("/logout",function(req,res){                                  //Deauthenticate the user
  req.logout();
  res.redirect("/");
})
...
app.post("/login",function(req,res){
  ...
  // User.findOne({email:username},function(err,foundUser){                      //mongoose-encrypt will decrypt the password automatically.
  //   if(err)
  //   {
  //     console.log(err);
  //   }
...
req.login(user,function(err){
  ...
  {
    passport.authenticate("local")(req,res,function(){                 //authenticate user suing local strategy
      res.redirect("/secrets");
    });
  }
})
